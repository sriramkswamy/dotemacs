...
(defun sk/insert-date-and-time (prefix)
...
#+BEGIN_SRC emacs-lisp
(bind-keys*
  ("C-z g U" . sk/duplicate-region)
  ("C-z g u" . sk/duplicate-current-line))
#+END_SRC
...
| *                     | C-z *               | multiple interactive edits           |
...
| SPC J                 | C-z SPC J           | helm smex major mode commands           |
