...
The default export engine doesn't treat the headings the way I want it. Also, sometimes I need it export differently - like a report instead of an article. Let's add some more structure to this.

#+BEGIN_SRC emacs-lisp
;; Exporting like a book
...
To use any of these classes add a statement like =#+LaTeX_CLASS: book= at the start of the org document.
