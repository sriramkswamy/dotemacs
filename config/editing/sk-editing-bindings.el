...
(global-set-key (kbd "C-c s h") 'sp-backward-down-sexp)
(global-set-key (kbd "C-c s l") 'sp-up-sexp)
(global-set-key (kbd "C-c s f") 'sp-forward-sexp)
(global-set-key (kbd "C-c s b") 'sp-backward-sexp)
...
(global-set-key (kbd "C-c s > >") 'sp-forward-barf-sexp)
(global-set-key (kbd "C-c s < <") 'sp-backward-barf-sexp)
(global-set-key (kbd "C-c s > <") 'sp-forward-slurp-sexp)
(global-set-key (kbd "C-c s < >") 'sp-backward-slurp-sexp)
