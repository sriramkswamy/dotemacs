...
(which-key-add-key-based-replacements
  ...
  "s S" "backward unwrap"
  "s (" "wrap selection with parens"
  "s )" "wrap selection with parens"
  "s [" "wrap selection with brackets"
  "s ]" "wrap selection with brackets"
  "s {" "wrap selection with braces"
  "s }" "wrap selection with braces"
  "s $" "wrap selection with latex-dollars"
  "s '" "wrap selection with single-quotes"
  "s `" "wrap selection with back-quotes"
  "s \"" "wrap with double-quotes"
  
  "S" "snippets"
  
  "SPC s" "replace word/expression"

  "I" "interactive edit word/symbol"
