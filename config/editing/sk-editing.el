...
(use-package multiple-cursors
  ...
  :bind (
	 ...
	 ("C-c M f" . mc/cycle-forward)
	 ("C-c M b" . mc/cycle-backward)
	 ("C-c M s" . mc/hide-unmatched-lines-mode)
	 ))
...
(use-package region-bindings-mode
  ...
  :bind (:map region-bindings-mode-map
	      ...
	      ("mK" . mc/skip-to-previous-like-this)
	      ("mJ" . mc/skip-to-next-like-this)
	      ("mm" . mc/mark-more-like-this-extended)
	      ("mh" . mc/edit-beginnings-of-lines)
	      ("ml" . mc/edit-ends-of-lines)
	      ("me" . mc/edit-lines)
	      ("mn" . mc/insert-numbers)
	      ("mf" . mc/cycle-forward)
	      ("mb" . mc/cycle-backward)
	      ("ms" . mc/hide-unmatched-lines-mode)
	      )
