...
(use-package evil-surround
  ...
  (general-evil-define-key '(normal) evil-surround-mode-map "s" '(evil-surround-region :which-key "surround"))
  (general-evil-define-key '(normal) evil-surround-mode-map "S" '(evil-Surround-region :which-key "surround in new line"))
  (general-evil-define-key '(visual) evil-surround-mode-map "s" '(evil-surround-region :which-key "surround"))
  (general-evil-define-key '(visual) evil-surround-mode-map "S" '(evil-Surround-region :which-key "surround in new line"))
  (general-evil-define-key '(operator) evil-surround-mode-map "s" '(evil-surround-edit :which-key "surround"))
  (general-evil-define-key '(operator) evil-surround-mode-map "S" '(evil-Surround-edit :which-key "surround in new line"))
  :config
