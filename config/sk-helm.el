...
;; ivy views is great. Use perspective itself when it's not available
(general-nvmap "gt" '(persp-next :which-key "next tab"))
(general-nvmap "gT" '(persp-prev :which-key "prev tab"))
