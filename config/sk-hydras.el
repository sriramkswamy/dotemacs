...
(defhydra sk/hydra-of-langs (:color red
 ...
 ^^^^^^^^^-----------------------|------------------|--------------|--------------|-------|----------------
 _c_++    _e_lisp    _d_oc    | _h_ previous _a_ll   | _+_ vertical   | _|_ vertical   | _s_tart | _H_ome    _q_uit
 _p_ython _r_/julia  _m_atlab | _l_ next     _f_irst | _-_ horizontal | ___ horizontal |       |         e_x_ecute
"
...
(defhydra sk/hydra-of-hydras (:color blue
 ...
 _w_indow    _m_ove      _l_ang  _s_earch  | _C_lose  _q_uit
 _h_elp      _r_epeat    _g_it   _c_ursors |
"
  ...
  ("r" sk/hydra-of-repeat/body :exit t)
