...
(ryo-modal-keys
 ...
 ("#" swiper-thing-at-point :name "swipe word")
 ("g /" swiper-all-thing-at-point :name "swipe word")
...
;; mapping with leader
(ryo-modal-key "SPC"
               '(("a" todoist :name "agenda" :norepeat t)
				 ("w" "C-x C-s" :name "save buffer" :norepeat t)
                 ("e" sk/open-git :name "git status" :norepeat t)
                 ...
                 ("c" sk/goto-markdown-notes-inbox :name "capture notes" :norepeat t)
...
;; common operators
(eval `(ryo-modal-keys
		("!" ,text-objects :then '(sk/shell-command-region-or-line))
...
(ryo-modal-keys
 ...
 ("c o l" sk/org-table-mode :name "org table mode")
 ...
 ("c o m" highlight-changes-mode :name "margins")
