...
(add-hook 'ess-r-mode-hook 'sk/enable-ryo-modal-mode)
(add-hook 'ess-r-mode-hook 'sk/ess-operator)

(add-hook 'ess-julia-mode-hook 'sk/enable-ryo-modal-mode)
(add-hook 'ess-julia-mode-hook 'sk/ess-operator)

;; top level bindings for R
...
;; top level bindings for julia
(ryo-modal-major-mode-keys
 'ess-julia-mode
 ;; general bindings
 ("m r" sk/julia :name "start julia")
 ("m z" ess-switch-to-ESS :name "switch to shell")
 ("m m" ess-load-file :name "load file")
 ("m l" ess-load-library :name "load library")
 ("m n" ess-r-load-file-namespaced :name "load file namespaced")
...
;; major mode bindings
(which-key-add-major-mode-key-based-replacements 'ess-r-mode
  "m d" "documentation"
  "m p" "packages"
  "m g" "debug"
  "m y" "roxy"
  ...
  "m s i" "in"
  "m s g" "go")
(which-key-add-major-mode-key-based-replacements 'ess-julia-mode
  "m d" "documentation"
  "m p" "packages"
  "m g" "debug"
  "m y" "roxy"
